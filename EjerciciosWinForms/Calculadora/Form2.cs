...
namespace EjerciciosWinForms.Calculadora
{
    public partial class Form2 : Form
    {
        ...
        private void InicializarComponentes()
        {
            ...
            //Posicion txtDisplay y lbl Operacion
        ...
        {
            lblOperacion.Text = $"Raiz({txtDisplay.Text})=";
            txtDisplay.Text = Math.Sqrt(Double.Parse(txtDisplay.Text)).ToString();

        }
        private void btnCuadrado_Click(object? sender, EventArgs e)
        {
            lblOperacion.Text = $"Cuadrado de {txtDisplay.Text}=";
